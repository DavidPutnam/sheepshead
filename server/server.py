...
GOOGLE_CLIENT_ID = os.environ.get("GOOGLE_CLIENT_ID", "298908306191-c9ng471f6tbh9nt1kiikkpr3n3rduueo.apps.googleusercontent.com")
...
async def chat_message(sid: str, message: dict):
    await sio.emit(event='message', data={'data': message['data']}, room=sid, skip_sid=sid)
